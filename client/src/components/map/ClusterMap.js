...
const ClusterMap = () => {
  ...
  const [points, setPoints] = useState([]);  //rooms in different format
  ...
  //whenever there is a change in rooms,the above method will get triggered

  useEffect(() => {
    supercluster.load(points);
    setClusters(supercluster.getClusters(bounds, zoom));
  }, [points, zoom, bounds]); //because you know when we zoom in or zoom out,different clusters will be created
  ...
  return (
    ...
    >
      ...
      {clusters.map((cluster) => {
        ...
        return (
          <Marker //this is marker for rooms
